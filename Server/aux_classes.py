"""
    ...
    Description:
        Class stock and class MLModel used to handle
        the stored data. 
"""
...
class Stock:
    def __init__(self, symbol, company, category, start):
        self.sym = symbol  # Stock symbol
        self.company = company  # Company name
        self.category = category  # Category: tech/medical/crpto
        self.start = start  # Initial training date
        self.last_update = datetime.today().strftime('%Y-%m-%d')  # Last update date
        self.classification = None  # List of toady and yesteday classifications
        self.technical_indicators = None  # Dictionary of technical indicators
        self.raw_data = None  # Raw dataframe downloaded from yahoo finance
        self.extended_df = None  # The same df with extension of TALIB columns
...
class MLModel:
    ...
    def predict(self):
        ...
        Returns:
            probabillity vector 
        """
        # Prepare yesterday's input for prediction
        ...
        # Prepare today's input for prediction
